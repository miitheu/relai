-- Fix the default model parameter: claude-haiku-4-20250414 does not exist
-- Replaces function with correct model default, preserving existing API key approach
